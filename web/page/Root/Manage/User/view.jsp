...
<ul class="pager">
	<li><a href="view.jsp?start=0">First</a></li>
	
	<c:choose>
		<c:when test="${param.start-pagesize>=0}">
			<li><a href="view.jsp?start=${param.start-(1 * pagesize)}">Previous</a></li>
		</c:when>
		<c:otherwise>
			<li><a>Previous</a></li>
		</c:otherwise>
	...
	<c:choose>
		<c:when test="${param.start+pagesize<number}">
			<li><a href="view.jsp?start=${param.start + ( 1 * pagesize)}">Next</a></li>
		</c:when>
		<c:otherwise>
			<li><a>Next</a></li>
		</c:otherwise>
	...
	<li><a href="view.jsp?start=${param.start * 0 + (pn - 1) * pagesize}">Last</a></li>
</ul>
</body>
</html>
